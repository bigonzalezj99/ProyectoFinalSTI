...
if(!$db_connection){
    ...
    $selectBranchOffice = oci_parse($db_connection, "SELECT idsucursal, descripcion, direccion, municipio, departamento FROM sucursal");
    ...
    <body class="bodyInicio">
        ...
        <div class="text-justify marginBottom">
            ...
            <br>
            <div class="tableInfo">
                <table id="tableSucursales" class="tableSucursales">
                    <thead>
                        <tr>
                            <th>Descripción</th>
                            <th>Dirección</th>
                    ...
                    <tbody>
                        ...
                        while($fila = oci_fetch_array($selectBranchOffice, OCI_ASSOC+OCI_RETURN_NULLS)){
                            ...
                            print "<td>
                                    <button id='btnEdit_".$fila["IDSUCURSAL"]."' class='btn btn-primary btnEdit'>
                                        <i class='fa fa-pencil-square-o' aria-hidden='true'></i>
                                    </button>
                                    <button id='btnDelete_".$fila["IDSUCURSAL"]."' class='btn btn-danger btnDelete'>
    ...
    <script>
        $(document).ready( function () {
            setTimeout(() => {
                let tableSucursales = $('#tableSucursales');
