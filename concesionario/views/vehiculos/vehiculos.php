...
if(!$db_connection){
    ...
    // Vehículos
    $selectBranchOffice = oci_parse($db_connection, "SELECT v.idvehiculos, v.descripcion, v.precio, v.imagen, tp.transmicion, t.tipo, m.marca, e.estado
                                                        FROM vehiculo v
    ...
    // Transmisiones
    //$conexionTransmiciones = oci_parse($db_connection, "SELECT idtipotransmicionvehiculo, transmicion FROM tipotransmicionvehiculo");
    //$executeTransmiciones = oci_execute($conexionTransmiciones);
