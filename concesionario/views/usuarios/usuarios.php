...
if (!$db_connection) {
    ...
    $selectBranchOffice = oci_parse($db_connection, "SELECT usuario.idusuario, usuario.email, usuario.password, rol.rol FROM usuario INNER JOIN rol ON usuario.idrol = rol.idrol");
